...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        List<String> list = new ArrayList<>(Arrays.asList("java","mariadb","html","css","mybaits"));
        ...
        /*병렬 스트림을 활용하면 처리해야할 데이터 요소가 많을 경우 효율적으로 처리할 수 있는 장점이 있다*/

        System.out.println("prarallel stream ===============");
