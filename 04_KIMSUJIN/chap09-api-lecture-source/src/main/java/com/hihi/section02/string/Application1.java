package com.hihi.section02.string;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 단, 이 메소드는 대소문자를 구분하여 비교한다.*/
        ...
        /*
        * concat() : 문자열에 인자로 전달된 문자열을 합치기 해서 새로운 문자열을 반환한다.
        * 원본 문자열에는 영향을 주지 않는다.
        * */
        ...
        * 단, 일치하는 문자가 없는 경우 -1을 반환한다.*/
        ...
        /*
        * lastIndexOf() : 문자열 탐색으 뒤에서(오른쪽)부터 하고 처음 일치하는 위치의 인덱스를 반환한다.
        * 단, 일치하는 문자가 없는 경우 -1을 반환한다.*/

        System.out.println("indexOf('a') : " + indexOf.lastIndexOf("a"));       //9 출력 뒤에 있는 a의 인덱스 출력
        //주의주의 인덱스는 고정값임!!!!!!!!!!!!! 뒤에서부터 읽었다고 뒤에가 0번이 아니야~
        System.out.println("indexOf('b') : " + indexOf.lastIndexOf("b"));
        ...
        * substring() :  문자열의 일부를 잘라내어 새로운 문자열을 반환한다.*/
        ...
        System.out.println("substring(0,4) : " + javamysql.substring(0, 4));
