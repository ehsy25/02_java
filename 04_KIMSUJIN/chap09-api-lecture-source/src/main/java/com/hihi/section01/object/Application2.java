...
import com.hihi.section01.object.book.Book;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 동일객체와 동등객체
        * 동일객체: 주소가 동일한 객체를 인스턴스를 동일객체라고 한다.
        * 동등객체: 주소는 다르더라도 필드값이 동일하나 객체를 동등객체라고 한다.*/
        ...
        System.out.println("두 인스턴스의 == 연산비교 : " + (book1 == book2));    //book.toString() == book2.toString()
