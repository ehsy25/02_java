...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        int year = 2025;
        int month = 9;  //월은 0~11로 사용하기 때문에 -1해줘야 함
        int dayOfMonth = 28;
        int hour = 16;
        int min = 27;
        int second = 0;
        ...
        * 1970년 1월 1일 0시 0분 0초를 지난 시간을 millisecond로 계산해서
        ...
        * 하지만 이렇게 사용하게 되면 각 필드에 매칭된느 정수를 다 외워야 사용이 가능해진다.
