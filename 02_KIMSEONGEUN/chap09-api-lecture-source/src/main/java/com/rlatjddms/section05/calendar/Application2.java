package com.rlatjddms.section05.calendar;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 2-2. 년, 월, 일, 시, 분, 초 정보를 이동해서 인스턴스를 생성*/
        ...
        * */
        ...
        /*
        * 인자로 전달하는 경우에 따라 필드 값을 반환받을 수 있다.
        * 하지만 이렇게 사용하게되면 각 필드에 매칭되는 정수를 다 외워야 사용이 가능해진다.
        * 따라서 처리된 정수를 상수 필드 형태로 제공하고 있다.
        * */
