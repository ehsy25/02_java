package com.rlatjddms.section02.string;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * compareTo() : 인자로 전달됨 문자열과 사전 순으로 비교를 하여
        ...
        * */
        ...
        /*
        * lastIndexOf() : 문자열 탐색을 뒤에서부터 하고 처음 일치하는 위치의 인덱스를 반화한다.
        * 단, 일치하는 문자가 없는 경우 -1을 반환한다.
        * */
        ...
        /*
        * toLowerCase() : 모든 문자을 소문자로 변환시킨다
        * toUpperCase() : 모든 문자을 대문자로 변환시킨다
        * */
