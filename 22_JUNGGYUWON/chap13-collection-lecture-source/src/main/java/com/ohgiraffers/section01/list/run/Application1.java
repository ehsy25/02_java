...
public class Application1 {
    ...
    public static void main(String[] args) {
         ...
         * 잡에서 컬렉션 프레임워크는 여러 개의 다양한 데이터들을 쉽고 효과적으로 처리할 수 있도록
         * 표준화된 방법을 제공하는 클래스들의 집합을 의미한다.
         * 즉, 데이터는 효율적으로 저장하는 자료구조와 데이털르 처리하는 알고리즘을 미리 구현해 놓은 클래스를 말한다.
         * */
        ...
        * */
        ...
        Collections.sort(stringList); // 오름차순 정리
        System.out.println("stringList = " + stringList);
