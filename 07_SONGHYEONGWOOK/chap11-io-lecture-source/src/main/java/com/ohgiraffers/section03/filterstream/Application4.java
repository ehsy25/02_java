...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        MemberDto[] outputMembers = {
                new MemberDto("user01", "pass01", "홍길동", "hong345@naver.com", 25, '남', 1250.7),
                new MemberDto("user02", "pass02", "유관순", "korea@naver.com", 16, '여', 1850.7),
                new MemberDto("user03", "pass03", "이순신", "leeson@naver.com", 35, '남', 3250.7)
        };
...
//                            new FileOutputStream("src/main/java/com/ohgiraffers/section03/filterstream/testObjectStream.txt", true)));
            ...
            if(exists){
                // 파일이 있을 경우
                objOut = new MyOutputStream( // MyOutputStream으로 변경
                        new BufferedOutputStream(
                                new FileOutputStream("src/main/java/com/ohgiraffers/section03/filterstream/testObjectStream.txt", true)));
