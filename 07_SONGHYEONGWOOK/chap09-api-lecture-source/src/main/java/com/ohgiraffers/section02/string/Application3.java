...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        while(st1.hasMoreTokens()) { // hasMoreTokens() : 현재 꺼낼 토큰이 있는지 없는지 체크
            System.out.println("st1 : st1.nextToken() = " + st1.nextToken()); // nextToken() : 현재값을 빼서 반납
        }

        // 없으면 그냥 날린다.
        while(st2.hasMoreTokens()) {
            System.out.println("st2 : st2.nextToken() = " + st2.nextToken());
        }

        while(st3.hasMoreTokens()) {
            System.out.println("st3 : st3.nextToken() = " + st3.nextToken());
        }

        /* 한 번 꺼내면 끝임. 다시 생성하고 싶으면 새롭게 객체 생성 */
        System.out.println("=================================");
        while(st3.hasMoreTokens()) {
            System.out.println("st3 : st3.nextToken() = " + st3.nextToken());
        }
...
//        String[] colors = colorStr.split("#/ ");
        ...
        // StringTokenizer의 두번째 인자 문자열 자체는 연속된 문자열이 아닌
