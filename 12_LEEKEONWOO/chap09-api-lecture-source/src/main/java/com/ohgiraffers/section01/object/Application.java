...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * 따라서 Object클래스가 가진 메소드를 자신의 것 처럼 사용할 수 있다.
        * */
        ...
        * 인스던스가 생성될 때 사용한 full class name과 @ 그리고 16진수 해쉬코드가 문자열로 반환
        ...
        * */
        ...
        System.out.println("======================================"); // 위아래 결과값이 같음(컴파일러가 자동으로 생략되어있는 toString()추가 )
