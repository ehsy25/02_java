...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println(Arrays.toString(empArr4));  // [300, 이순신, 경기도, ]

        String[] empArr5 = emp1.split("/", 3); // [100, 홍길동, 서울/영업부]
        ...
        while(st1.hasMoreTokens()){ // hasMoreTokens() : 현재 꺼낼 토큰이 있는지 확인
            System.out.println("st1 : " + st1.nextToken()); // nextToken() : 확인한 값 빼서 반납
        }
        ...
        System.out.println("==========================");
        while(st3.hasMoreTokens()){
            System.out.println("st3 : " + st3.nextToken()); // 한번 빼낸 객체는 비어서 결과값이 출력 안됨
        }

        String colorStr = "red*orange#blue/yellow green";
        String[] colors = colorStr.split("[*/ #]"); // "[]" : 정규표현식 => []안에 있는 문자들 모두
