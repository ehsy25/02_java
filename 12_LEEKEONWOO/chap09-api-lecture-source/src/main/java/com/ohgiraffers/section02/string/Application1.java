...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        for (int i = 0; i < str1.length(); i++) { // <= 를 넣으면 IndexOutOfBoundException 발생
        ...
        * */
        ...
        String str4 = "JAVA";
        String str5 = "oracle";
        System.out.println("compareTo() : " + (str2.compareTo(str3))); //문자 하나하나 비교
        ...
        * */
        ...
        System.out.println("str2 = " + str2); //원본에는 영향을 끼치지 않는다.

        /*
        * indexOf() : 문자열에서 특정 문자를 탐색하여 처음 일치하는 인덱스 위치를 정수형으로 반환한다.
        * 당, 일치하는 문자가 없는경우 -1을 반환한다.
        * */
        ...
        * */
        ...
        System.out.println("trimStr : #" + trimStr.trim() + "#"); //원본은 건드리지 않는다.
        ...
        * */
        ...
        System.out.println("substring(3, 6) : " + javamysql.substring(3, 6)); // 3번째 문자부터 6번째 문자 => ja|vam|qsql
        System.out.println("substring(3) : " + javamysql.substring(3)); // 끝까지 다

        /* isEmpty() : 문자열의 길이가 0이면 true를 반환, 아니면 false반환
        * */
        System.out.println("isEmpty() : " + "".isEmpty());
        System.out.println("isEmpty(abc) : " + "abc".isEmpty());
