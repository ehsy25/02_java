...
//        Integer boxingNumber1 = new Integer(intValue);
        ...
        * integerNum1 == integerNum2 가 true가 나올수있다.
        * */
        ...
        System.out.println("int와 Integer 비교 : " + (inum == integerNum1)); // true, Integer, int 값비교
        System.out.println("int와 Integer 비교 : " + (inum == integerNum3)); // true

        System.out.println("integer와 integer 비교 : " + (integerNum1 == integerNum2)); // true Integer, Integer 주소값비교
