...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * Tiger는 Tiger타입 이기도 하면서 Animal타입이기도 하다.
        * */
        ...
        /* Animal은 Animal 타임 이지 Tiger 나 Rabbit 이 아니다. */
//        Rabbit rabbit1 = new Animal();
//        Tiger tiger1 = new Animal();

        System.out.println("동적 바인딩 ===========================");
//        런타임 시에는 부모 클래스로 가지만 컴파일 되면서 자식 클래스에 우선권이 있다.
        animal1.cry();
        animal2.cry();
...
//        ((Tiger) animal1).bite();  <=== ClassCastException
        /*
        * instanceof 연산자 이용
        ...
        * */
        ...
        Rabbit rabbit1 = (Rabbit) animal3;      // Animal -> Rabbit 다운캐스팅
                                                // 명시적 형변환
//        Rabbit rabbit2 = animal3;             // 다운캐스팅은 묵시적 형변환 불가능
