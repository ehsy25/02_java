package com.ohgiraffers.section02.superkeyoword;
...
public class Computer extends Product {
    ...
    public Computer() {
        System.out.println("Computer기본 생성자 호출");
    }
    ...
    public Computer(String code, String brand, String name, int price, Date manufacturingDate,
                    String cpu, int ssd, int ram, String operationSystem) {
        super(code, brand, name, price, manufacturingDate); // 할상 맨위에 있어야 한다
        this.cpu = cpu;
        this.ssd = ssd;
        this.ram = ram;
        this.operationSystem = operationSystem;
//        this (cpu,ssd,ram,operationSystem);
    ...
    * 따로 작성할 필요 없이 부모클래스에 작성한것을 사용할 수 있다.
    ...
    * */
    ...
    public String getInfromarion() {
        ...
        * 따라서 이런 경우 super.을 명시적으로 사용해야된다.
        * */
        return super.getInfromarion()
                + ", cpu = " + this.cpu
                + ", ssd = " + this.ssd
                + ", ram = " + this.ram
