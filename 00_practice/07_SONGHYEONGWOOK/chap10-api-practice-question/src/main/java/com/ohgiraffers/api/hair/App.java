...
////        String reservationDateField = "";
////        String reservationTimeField = "";
////        String createdTimeField = "";
//
...
////            }
////
////            if(firstNameField == "first_name") {
////                firstName =  st.nextToken();
////            } else {
////                firstNameField = st.nextToken();
////            }
////
////            if(lastNameField == "last_name") {
////                lastName =  st.nextToken();
////            } else {
////                lastNameField = st.nextToken();
////            }
////
////            if(emailField == "email") {
////                email = st.nextToken();
////            } else {
////                emailField = st.nextToken();
////            }
////
////            if(genderField == "gender") {
////                gender =  st.nextToken();
////            } else {
////                genderField = st.nextToken();
////            }
////
////            if(birthdayField == "birthday") {
//////                birthday = birthday.format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
////                birthday =  LocalDate.parse(st.nextToken(), DateTimeFormatter.ofPattern("yyyy/MM/dd"));
//////            birthday =  LocalDate.parse(st.nextToken());
////            } else {
////                birthdayField = st.nextToken();
////            }
////
////            if(reservationDateField == "reservation_date") {
////                reservationDate = LocalDate.parse(st.nextToken(), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
////            } else {
////                reservationDateField = st.nextToken();
////            }
////
////            if(reservationTimeField == "reservation_time") {
////                reservationTime = LocalTime.parse(st.nextToken(), DateTimeFormatter.ofPattern("HH:mm"));
////            } else {
////                reservationTimeField = st.nextToken();
////            }
////
////            if(createdTimeField == "created_at") {
////                createdTime = LocalDateTime.parse(st.nextToken(), DateTimeFormatter.ofPattern("yyyy-MM-ddTHH:mm:ss"));
////            } else {
////                createdTimeField = st.nextToken();
////            }
//
...
////
////
////            users[index] = new User(id, firstName, lastName, email, gender, birthday, reservationDate, reservationTime, createdTime);
////            index++;
//
//        }
//
////        for(int i = 0; i < index; i++) {
////            System.out.println(users[i].information().toString());
////        }
//
//    }
//
