...
//
//
//        for(int i = 1; infos.length > index; i++) {
...
//
//                }
//                LocalDate birthday = LocalDate.parse(st.nextToken(), DateTimeFormatter.ofPattern("yyyy/MM/dd"));
//                LocalDate reservationDate = LocalDate.parse(st.nextToken(), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
//                LocalTime reservationTime = LocalTime.parse(st.nextToken(), DateTimeFormatter.ofPattern("HH:mm"));
