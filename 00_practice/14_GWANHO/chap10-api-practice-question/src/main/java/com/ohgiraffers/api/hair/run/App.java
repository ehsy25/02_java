...
//        }
    ...
    private static LocalTime toTime(String str, String delimiter) {
        if(str.isEmpty()) {
            return null;
        }
        ...
        return LocalTime.of(time[0], time[1], time[2]);
    }

    private static LocalDateTime toDateTime(String str, String delimiter) {
        String[] dates = str.split(delimiter);

        LocalDate date = toDate(dates[0], "-");
        LocalTime time = toTime(dates[1], ":");
