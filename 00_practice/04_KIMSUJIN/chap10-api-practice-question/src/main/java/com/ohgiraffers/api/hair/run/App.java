...
//        System.out.println(arr.length);
        ...
        for(int i = 1; i < arr.length; i++){
            ...
            if (user[5].isEmpty()){
                ...
                u.setBirthDate(LocalDate.parse(user[5], DateTimeFormatter.ofPattern("yyyy/MM/dd")));}

            u.setReservationDate(LocalDate.parse(user[6], DateTimeFormatter.ofPattern("yyyy-MM-dd")));
            u.setReservationTime(LocalTime.parse(user[7],  DateTimeFormatter.ofPattern("H:mm")));
            u.setCreatedAt(LocalDateTime.parse(user[8]));
