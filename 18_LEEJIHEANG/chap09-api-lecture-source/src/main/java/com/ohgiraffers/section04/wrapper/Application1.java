...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 래퍼크래스 타입의 인스턴스를 기본 타입으로 변경하는 것을 언박싱(UnBoxing)이라고 한다.
        * */
        int intValue = 20;
//        Integer boxingNumber1 = new Integer(intValue);
        Integer boxingNumber = Integer.valueOf(intValue); // static메소드 int-> Integer
        ...
        * */
        int inum = 20;
        Integer integerNum1 = Integer.valueOf(20); //20을 박싱
        Integer integerNum2 = Integer.valueOf(20); // 박싱
        Integer integerNum3 = 20; // 오토박싱
        Integer integerNum4 = 20; // 오토박싱

        System.out.println("int와 Integer 비교 : " + (inum == integerNum1)); // Integer, int는 값비교
