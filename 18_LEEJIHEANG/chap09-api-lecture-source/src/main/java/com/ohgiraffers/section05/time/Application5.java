...
public class Application5 {
    ...
    public static void main(String[] args) {
        ...
        LocalTime localDate = LocalTime.from(LocalDate.parse(dateNow));
        ...
        LocalTime localTim1 = LocalTime.now();

        String dateFormat = localDate1.format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        String timeFormat = localTim1.format(DateTimeFormatter.ofPattern("HH:mm:ss"));
