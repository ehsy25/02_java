...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        LocalTime timeOf = LocalTime.of(9,12,0);
        ...
        // of() : 매개변수로 java.util.TimeZone의 getAvailabeIDs() 메소드가 반환하는 값을 넣어 ZoneId반환 받을 수 있다.
...
//    ZonedDateTime zonedDateTimeOf = zonedDateTimeNow.of(dateOf,timeOf.of("Asia/Seoul"));
    }
