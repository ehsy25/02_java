...
public class Application2 {
    ...
    * 즉 , 동일한 인스턴스인지를 비교하는 기능을 한다.
    /*
   * 동일객체와 동등객체
   * 동일객체: 주소가 동일한 인스턴스를 동일객체라고 한다. same object
   * 동등객체: 주소는 다르더라도 필드값이 동일한 객체를 동등객체라고 한다. equal object
   * */
        ...
        //주소가 다르고 필드값이 동일하므로 동등객체라고 한다. equal object

        System.out.println("두 인스턴스의 == 연산 비교 : " + (book1.toString() == book2.toString()));
