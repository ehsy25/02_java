...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        String emp2 = "200/유관순//총무부"; // 4개
        String emp3 = "300/이순신/경기도/"; // 3개
//alt+ctrl+v
        ...
        String[] empArr5 = emp1.split("/", 3); // 3개만 자르기
        System.out.println(Arrays.toString(empArr5));

        StringTokenizer st1 = new StringTokenizer(emp1, "/"); // 100, 홍길동, 서울, 영업부
        StringTokenizer st2 = new StringTokenizer(emp2, "/"); // hasMoreTokens() nextToken()
        ...
        while (st3.hasMoreTokens()) { // 현재 꺼낼 토큰이 있는지 업는지 체크
            System.out.println("st3 : " + st3.nextToken()); // 현재 값을 빼서 반납
        }
        System.out.println("================================================");
