...
public class Application {
    ...
    File file = new File("src/main/java/com/ohgiraffers/section01/file/test.txt");
        ...
        String path = "c:\\한화시스템 Beyond SW캠프_21기\\devTest\\test";
        ...
        boolean deleteSuccess2 = new File("c:\\한화시스템 Beyond SW캠프_21기\\devTest").delete();
        ...
        if(!testFile.exists()){
            boolean createFolder = testFile.mkdirs();
        }
