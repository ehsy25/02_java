...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * comparedTo() : 인자로 전달된 문자열과 사전 순으로 비교를 하여
        ...
        * */
        ...
        System.out.println("comparedTo() : " + str2.compareTo(str4)); // 32

        System.out.println("comparedTo() : " + str4.compareTo(str2)); // -32
        // j: 106 o: 111
        System.out.println("comparedTo() : " + str2.compareTo(str5)); // -5
        System.out.println("comparedTo() : " + str5.compareTo(str2)); // 5
        System.out.println("comparedTo() : " + str3.compareTo(str4)); // 5
        ...
        * */
        ...
        String trimStr = "  java  ";
        String.out.println("trimStr : #" + trimStr + "#");
        String.out.println("trimStr : #" + trimStr.trim() + "#");
        String.out.println("trimStr : #" + trimStr + "#");
        ...
        * */
        ...
        System.out.println("substring(0) : " + javamysql);
