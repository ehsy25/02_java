...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        Calendar calendar1 = new GregorianCalendar(year, month, dateOfMonth, hourOfDay, minute, second);
        System.out.println(calendar1);

        /*
        * 상황에 따라 특정 일자를 기준으로 한 Date타입의 인스턴스가 필요한 경우도 있다.
        * 먼저 GregorianCalender를 이용해서 특정 날짜/시간 정보로 인스턴스를 생성한 후
        ...
        * */
        ...
        System.out.println("day of week : " + calendar1.get(Calendar.DAY_OF_WEEK));

        String day = "";
        switch (calendar1.get(Calendar.DAY_OF_WEEK)) {
            case Calendar.SUNDAY: day = "일"; break;
            case Calendar.MONDAY: day = "월"; break;
            case Calendar.TUESDAY:DAY: day = "화"; break;
            case Calendar.WEDNESDAY:DAY: day = "수"; break;
            case Calendar.THURSDAY:DAY: day = "목"; break;
            case Calendar.FRIDAY: day = "금"; break;
            case Calendar.SATURDAY:DAY: day = "토"; break;
