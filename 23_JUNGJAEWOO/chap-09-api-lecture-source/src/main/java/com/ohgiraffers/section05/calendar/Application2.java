...
public class Application2 {
    public static void main(String[] args) {
        ...
        int year = 2025;
        int month = 9; // 월은 0~11월로 사용하기 떄문에 9는 10월을 의미한다.
        int monthOfday = 28;
        int hour = 16;
        int minute = 27;
        int second = 0;

        Calendar calendar1 = new GregorianCalendar(year, month, monthOfday, hour, minute, second);
        ...
        **/
        ...
        Date date2 = new Date(new GregorianCalendar(year, month, monthOfday, hour, minute, second).getTimeInMillis());

        /* 인자로 전달하는 정수에 따라 필드 값을 반환받을 수 있다.
        * 하지만 이렇게 사용하게 되면 각필드에 매칭되는 정수를 다 외워야 사용이 가능해진다.
        * 따라서 저러한 정수를 상수 필드 형태로 제공하고 있따.
        * */
