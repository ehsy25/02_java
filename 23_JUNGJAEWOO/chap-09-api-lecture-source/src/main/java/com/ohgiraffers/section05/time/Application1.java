...
public class Application1 {
    public static void main(String[] args) {
        ...
        LocalDate dateOf = LocalDate.of(2025, 1, 1);
        ...
        // ZoneDateTime
        // now() : ZoneId를 매개변수로 넘겨주면 ZoneDateTime 객체를 반환
        // of() : 매개변수로 java.util.TimeZone의 getAvailableIDs() 메소드가 반환하는 값을 넣어 ZoneID 반환 받을 수 있다.
