...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(empArr3));   // 마지막 항목 없음

        System.out.println("===========================");
        // limit 인자에 음수를 넣으면 마지막 구분자 뒤의 값이 존재하지 않는 경우
        // 빈 문자열로 토큰을 생성
        String[] empArr4 = emp3.split("/", -1);
        System.out.println(Arrays.toString(empArr4));

        // limit: 개수 제한 인자.
        String[] empArr5 = emp1.split("/", 2);
        ...
        // 정규표현식으로 다양한 문자 기준으로 스플릿
        String colorStr = "red*orange#blue/yellow green";
        String[] colors = colorStr.split("[*/# ]");
        System.out.println(Arrays.toString(colors));

        // StringTokenizer의 두번째 인자 문자열에서는 하나의 구분자가 아닌
        // 각각의 구분자로 인식
        StringTokenizer colorST = new StringTokenizer(colorStr, "*/ #");
        while (colorST.hasMoreTokens()) {
            System.out.println("colorST : " + colorST.nextToken());
        }
