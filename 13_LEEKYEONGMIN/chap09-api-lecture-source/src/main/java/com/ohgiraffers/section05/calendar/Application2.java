...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 2025년 10월 28일 16:29:00 */
        int year = 2025;
        int month = 9; //월은 0~11로 사용하므로 9는 10월을 의미함
        int dayOfMonth = 28;
        int hour = 16;
        int minute = 29;
        int second = 0;
        ...
        1970년 1월 1일 0시 0분 0초를 기준으로 지난 시간을 millisecond로 걔산해서
        ...
        /* 생성된 인스턴스의 필드 정보를 Calendar클래스에 있는 get()메소드를 이용하여 반환할 수 있다. */
        ...
        /* 인자로 전달하는 정수에 따라 필드값을 반환받을 수 있다.
