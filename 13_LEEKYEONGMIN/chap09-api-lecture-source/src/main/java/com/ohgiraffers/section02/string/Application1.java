...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("compareTo() : " + (str4.compareTo(str2))); //-32 뒤가 더 크면 음수
        // j:106  o:111
        ...
        System.out.println("trimStr : #" + trimStr+"#"); //원본은 안건드림
        ...
        /*
        substring() : 문자열의 일부를 잘라내여 새로운 문자열을 반환한다.
         */
        ...
        /*
        isEmpty() : 문자열을 길이가 0이면 true를 반환, 아니면 false를 반환
         */
